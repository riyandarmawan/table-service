...
Route::middleware('auth')->group(callback: function () {
    ...
    Route::middleware('checkRole:administrator,waiter')->group(function () {
        // menu
    ...
    Route::middleware('checkRole:waiter')->group(function () {
        // pesanan
    ...
    Route::middleware('checkRole:waiter,kasir,owner')->group(function () {
        // dashboard
